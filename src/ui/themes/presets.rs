    ...
    pub fn get_cometix() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_cometix::glm_coding_plan_segment(),
    ...
    pub fn get_default() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_default::glm_coding_plan_segment(),
    ...
    pub fn get_minimal() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_minimal::glm_coding_plan_segment(),
    ...
    pub fn get_gruvbox() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_gruvbox::glm_coding_plan_segment(),
    ...
    pub fn get_nord() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_nord::glm_coding_plan_segment(),
    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::glm_coding_plan_segment(),
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::glm_coding_plan_segment(),
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::glm_coding_plan_segment(),
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::glm_coding_plan_segment(),
